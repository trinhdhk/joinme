...
To customise priors or the baseline hazard basis, supply `priors = jm_prior(...)` and the relevant model arguments. Distributional regression for parameters such as $\sigma$ or $\nu$ can be specified through `formulaDist`.
