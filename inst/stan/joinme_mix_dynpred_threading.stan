...
functions {
  ...
  #include helper/functions/latent_progress_mixture.stanfunctions
...
data {
  ...
  #include helper/data/dynpred_mixture_data.stan
...
model {
  ...
  #include helper/model/dynpred_mixture_prior.stan
}

generated quantities {
  #include helper/generated_quantities/dynpred_output_declarations.stan
  #include helper/generated_quantities/dynpred_mixture_output_declarations.stan
  #include helper/generated_quantities/dynpred_mixture_output_calculations.stan
