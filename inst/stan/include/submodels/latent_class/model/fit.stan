/**
 * @file include/submodels/latent_class/model/fit.stan
 * @brief Replace selected standardised random-effect priors by a finite mixture.
 *
 * @details
 * The master mixture programme first includes the established JoiNMe priors
 * from the five submodels and `regression_priors.stan`. This block then
 * subtracts the density of each selected coordinate and adds the
