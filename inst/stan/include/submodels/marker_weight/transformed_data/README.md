# Marker-weight submodel: Transformed data

[Back to the marker-weight submodel story](../README.md) · [Master submodel guide](../../README.md)

## Statistical purpose

Documents that weight-sharing maps arrive fully prepared from R.

There is no additional deterministic Stan construction before sampling or prediction.
