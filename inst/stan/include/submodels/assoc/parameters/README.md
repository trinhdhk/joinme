# Association submodel: Parameters

[Back to the association submodel story](../README.md) · [Master submodel guide](../../README.md)

## Statistical purpose

Declares raw association coefficients for fitted models.

Dynamic prediction conditions on their posterior draws and introduces no association-only parameter.
