# Functional-transformation submodel: Transformed parameters

[Back to the functional-transformation submodel story](../README.md) · [Master submodel guide](../../README.md)

## Statistical purpose

Constructs unit-span monotone curves and restores fitted affine intercepts and slopes.

The unit-span constraint separates transformation shape from the scale of the association coefficient.
