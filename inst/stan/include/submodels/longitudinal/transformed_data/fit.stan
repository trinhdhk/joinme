/**
 * @file longitudinal/transformed_data/fit.stan
 * @brief Construct stable packed indices for covariance-regression coordinates.
 *
 * @details
 * The covariance association and covariance-regression calculations use the
 * same lower-triangular order.  These indices are deterministic functions of
 * the longitudinal random-effect dimension and are therefore prepared once
 * before sampling.
 */
/**
