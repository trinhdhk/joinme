/**
 * @file dynpred_threaded_likelihood.stan
 * @brief Shared draw-wise conditioning likelihood for dynamic prediction.
 *
 * @details Observation and event conditioning are common to ordinary and
 * latent-class prediction. The latter restores fitted mixture priors through
 * `include/submodels/latent_class/model/dynamic_prediction.stan` after this common
 * likelihood call.
 */
