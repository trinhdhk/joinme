 ...
 *
 * @details
 * Coefficient-local horseshoe scales and component-role global and slab scales are stored once because the prior interpreter spans several scientific submodels without giving them a common regularisation group.
 */
  /**
   ...
   */
  vector<lower=0>[n_regression_horseshoe_local] horseshoe_local_regression; // coefficient-specific local regularisation scales
  vector<lower=0>[n_regression_horseshoe_group] horseshoe_global_regression; // component-role global regularisation scales
