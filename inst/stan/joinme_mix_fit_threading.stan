...
data {
  ...
  #include helper/data/fit_mixture_data.stan
...
parameters {
  ...
  #include helper/parameters/joinme_fit_mixture.stan
}

transformed parameters {
  #include helper/transformed_parameters/fit_scaling_and_effects.stan
  #include helper/transformed_parameters/fit_mixture_locations.stan
}
...
generated quantities {
  ...
  #include helper/generated_quantities/fit_mixture_outputs.stan
}
