/**
 * @file dynpred_mixture_data.stan
...
int<lower=1> dynamic_n_clusters; // common number of fitted latent classes
...
matrix<lower=0>[n_draws, dynamic_n_clusters]
...
int<lower=0, upper=1> dynamic_mix_subject; // whether shared-subject effects are clustered
...
int<lower=0, upper=1> dynamic_mix_covariance; // whether covariance-regression effects are clustered
...
int<lower=0, upper=1> dynamic_mix_marker; // whether shared-marker effects are clustered
