/**
 * @file joinme_fitpred_threading.stan
 * @brief Prediction using posterior random effects of subjects represented in the fit.
 *
 * @details
 ...
 * in paired posterior draws from `joinme()`. It avoids fitting a second set of
 * subject effects while preserving the exact equations used by dynamic
 * prediction.
 */
