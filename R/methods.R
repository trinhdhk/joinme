...
summary.JoinMeFit <- function(object, draws = NULL, seed = 1, digits = 3,
  ...
  all_vars <- tryCatch(fit$summary()$variable, error = function(e) character(0))
...
ranef.JoinMeFit <- function(object, draws = NULL, seed = 1, digits = 3, ...) {
  ...
  vars <- tryCatch(fit$summary()$variable, error = function(e) character(0))
